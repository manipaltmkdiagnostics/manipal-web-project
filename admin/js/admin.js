...
function initUI() {
    ...
    if (isMaster) {
        roleEl.innerHTML = '<span style="background:var(--primary);color:white;padding:3px 8px;border-radius:12px;font-size:0.75rem;font-weight:bold;">👑 Master Admin</span>';
    } else {
